...
class OrchestratorAdapter:
    ...
    def adapt(self, orchestrator_output: Dict[str, Any]) -> SchemaVanguardInput:
        ...
        regime_dict = orchestrator_output.get("regime_snapshot") or {}
        regime = RegimeSnapshot(
            as_of_utc=regime_dict.get("as_of_utc") or "MISSING_as_of_utc",
            regime_state=regime_dict.get("regime_state") or "MISSING_regime_state",
            dir_bias=regime_dict.get("dir_bias") or "MISSING_dir_bias",
            vol_mode=regime_dict.get("vol_mode") or regime_dict.get("volatility_mode") or "MISSING_vol_mode",
            regime_drift_status=regime_dict.get("regime_drift_status") or "MISSING_regime_drift_status",
            macro_conviction=regime_dict.get("macro_conviction") or "MISSING_macro_conviction",
        )
