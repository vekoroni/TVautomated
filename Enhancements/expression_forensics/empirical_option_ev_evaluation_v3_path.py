...
OUT = Path(__file__).resolve().parent / "empirical_option_ev_evaluation_v3_path.json"
...
def main():
    ...
    for path in sorted(glob.glob(str(MAIN / "data/output/runs/*/options/options_intelligence_*.csv"))):
        ...
        for r in frame.to_dict("records"):
            ...
            n = new.compute_path_option_ev(**inputs, calibration=calibration, paths=new.PATH_SETTINGS["paths"],
                                           seed=new.PATH_SETTINGS["seed"])
