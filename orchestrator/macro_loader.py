...
v1.1 changes:
  - VALID_VALUES expanded to accept all AVSHUNTER_GPT output variants
    (uppercase compound values, MODERATE conviction, extended sector_bias values)
  - Backward compatible: legacy MacroLoader values still accepted
...
VALID_VALUES = {
    ...
    'risk_on_switch': {
        'ON', 'OFF',
        'NEUTRAL_TO_RISK_ON', 'NEUTRAL_TO_RISK_OFF',
        'RISK_ON_TILT', 'RISK_OFF_TILT',
        'NEUTRAL',
    },
    # regime_state: AVSHUNTER_GPT uses uppercase compound values
    'regime_state': {
        # Legacy MacroLoader values (kept for backward compat)
        'Risk-On', 'Risk-Off', 'Transitional', 'Crisis', 'Recovery',
        # AVSHUNTER_GPT uppercase values (actual pipeline output)
        'TRENDING_BULL', 'RISK_ON', 'RECOVERY',
        'TRENDING_BEAR', 'RISK_OFF', 'CRISIS',
        'CHOPPY_NEUTRAL', 'NEUTRAL', 'TRANSITIONAL',
        'RISK_OFF_TILT', 'NEUTRAL_TO_RISK_OFF',
        'NEUTRAL_TO_DEFENSIVE', 'NEUTRAL_TO_RISK_ON',
        'MIXED', 'UNKNOWN',
    },
    # dir_bias: AVSHUNTER_GPT uses uppercase with underscores
    'dir_bias': {
        # Legacy values
        'Bullish', 'Neutral-Bullish', 'Neutral', 'Neutral-Defensive',
        'Bearish', 'Strongly-Bearish',
        # AVSHUNTER_GPT values
        'BULLISH', 'NEUTRAL_TO_BULLISH', 'NEUTRAL',
        'NEUTRAL_TO_DEFENSIVE', 'NEUTRAL_TO_BEARISH',
        'BEARISH', 'STRONGLY_BEARISH',
        'DEFENSIVE',
    },
    # regime_drift_status: case-insensitive variants
    'regime_drift_status': {
        'Stable', 'Drifting', 'Accelerating', 'Reversing',
        'STABLE', 'DRIFTING', 'ACCELERATING', 'REVERSING',
    },
    # macro_conviction: mixed case variants
    'macro_conviction': {
        'Low', 'Medium', 'High',
        'LOW', 'MODERATE', 'HIGH',       # AVSHUNTER_GPT uses MODERATE not Medium
    },
    # liquidity_status: AVSHUNTER_GPT produces compound values
    'liquidity_status': {
        'FLOODED', 'STABLE', 'NEUTRAL', 'DRAINING',
        'MODERATE_STABLE', 'MILD_TIGHTENING_STABLE',
        'TIGHTENING', 'EASING', 'MODERATE',
    },
    # volatility_mode: AVSHUNTER_GPT uses compound values
    'volatility_mode': {
        'Suppressed', 'Contained', 'Elevated', 'Expanding',
        'Expanding-Front-Loaded', 'Unknown',
        'SUPPRESSED', 'CONTAINED', 'ELEVATED', 'EXPANDING',
        'ELEVATED_RISK', 'VOL_EXPANDING', 'VOL_SUPPRESSED',
        'ELEVATED_FRONT_LOADED', 'UNKNOWN',
    },
    # sector_bias values: AVSHUNTER_GPT uses additional nuanced values
    'sector_bias_values': {
        'FAVOUR', 'NEUTRAL', 'AVOID',
        'SELECTIVE', 'SELECTIVE_ONLY',
        'UNDERWEIGHT', 'OVERWEIGHT',
        'FAVOUR_TACTICAL', 'GOLD_HEDGE_FAVOUR',
        'REDUCE_BETA',
    },
}
