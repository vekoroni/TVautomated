...
def _check_contract(live_data: Dict[str, Any], spread_threshold: float) -> tuple[bool, str]:
    """
    Returns (passed, reason).
...
def run_gate(
    ...
    contract_pass, contract_reason = _check_contract(live_data, spread_threshold)
