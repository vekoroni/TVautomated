...
class ExecutionVerdict:
    ...
    eil_raw_verdict: str                # Actual verdict regardless of advisory mode
                                        # e.g. EXECUTE_NOW even when eil_verdict=ADVISORY_ONLY
                                        # Allows operator review without disabling advisory flag
