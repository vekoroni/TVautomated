...
REGIME_EV_FLOORS = {
    "RISK_ON":       (0.010, 0.36),   # 1.0% EV floor, 36% win rate floor
    "TRANSITIONAL":  (0.015, 0.38),   # 1.5% EV floor, 38% win rate floor
    "RISK_OFF":      (0.030, 0.44),   # 3.0% EV floor, 44% win rate floor
}
