...
REGIME_EV_FLOORS = {
    "RISK_ON":                (0.010, 0.36),
    # ENHANCEMENT 2 (2026-04-16): TRANSITIONAL sub-regimes
    # BULLISH: SPY uptrend + VIX falling → looser floor, tailwind supports longs
    # NEUTRAL: mixed signals → same as base TRANSITIONAL
    # BEARISH: SPY weak or VIX rising → tighter floor, headwind demands more edge
    "TRANSITIONAL_BULLISH":   (0.010, 0.36),   # same as RISK_ON — tailwind present
    "TRANSITIONAL_NEUTRAL":   (0.015, 0.38),   # base TRANSITIONAL
    "TRANSITIONAL":           (0.015, 0.38),   # backward compat
    "TRANSITIONAL_BEARISH":   (0.022, 0.41),   # tighter — headwind
    "RISK_OFF":               (0.030, 0.44),
}

REGIME_SETUP_FORMING_FLOORS = {
    "RISK_ON":                (0.000, 0.32),
    "TRANSITIONAL_BULLISH":   (0.000, 0.32),
    "TRANSITIONAL_NEUTRAL":   (0.003, 0.34),
    "TRANSITIONAL":           (0.003, 0.34),
    "TRANSITIONAL_BEARISH":   (0.006, 0.36),
    "RISK_OFF":               (0.008, 0.38),
}
