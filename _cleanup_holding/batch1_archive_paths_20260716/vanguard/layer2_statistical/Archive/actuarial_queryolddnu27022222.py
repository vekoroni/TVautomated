...
class ActuarialQueryEngine:
    ...
    def _find_similar_states(self, state: StateVector) -> pd.DataFrame:
        ...
        Stage 1 — Full 7-dimension match (preferred):
        ...
        Stage 2 — Core 4-dimension match (fallback when bucket columns
          don't exist in DB or no Stage 1 matches found):
          vol_regime + trend_direction + trend_maturity + structure_quality
          This is the pre-bucket behaviour — used as floor.
        ...
        # ── STAGE 2: Core 4-dimension fallback (bucket columns missing/empty) ─
