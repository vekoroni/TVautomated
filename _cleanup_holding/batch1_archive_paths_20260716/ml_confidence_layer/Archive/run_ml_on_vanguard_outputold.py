...
from ml_confidence_layer.ml_confidence_engine import (
    MLConfidenceEngine, VanguardInput, MLConfidenceResult
)
...
def map_vanguard_row(row: pd.Series, macro_regime: str) -> VanguardInput:
    """
    Map a VANGUARD CSV row to VanguardInput.
...
def format_output(v_input: VanguardInput, result: MLConfidenceResult) -> dict:
    return {
