...
def build_columns():
    ...
    return [
        ...
        ("Priority_Rank", lambda s: s.get("priority_rank") or ""),
        ...
        ("Vetoes_Count", lambda s: s.get("sb_vetoes_count") or ""),
        ...
        ("EIL_Raw_Verdict", lambda s: s.get("eil__raw_verdict") or ""),
        ("EIL_Composite", lambda s: s.get("eil__composite_score") or s.get("eil__composite") or ""),
