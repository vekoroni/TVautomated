...
FINAL_BOOK_FIELDS = [
    ...
    "spread_above_limit",
    "contract_value_selection_mode",
    "contract_value_basis",
    "contract_value_quality_flag",
    "contract_value_r_central",
    "contract_value_r_cautious",
    "contract_value_score_choice_symbol",
    ...
    "oi_positioning_state",
    "volume_activity_state",
    "option_activity_state",
    "activity_evidence_strength",
    "activity_directional_inference",
    "activity_authority",
    "activity_reason",
    ...
    *,
    ...
    row = {
        ...
        **{field: sig.get(field) for field in (
        ...
        "physics_verdict": first(sig, "physics_verdict"),
        ...
        "pcr_direction_conflict_status": first(sig, "pcr_direction_conflict_status"),
        "pcr_direction_conflict_reason": first(sig, "pcr_direction_conflict_reason"),
        "pcr_confidence_weight": first(sig, "pcr_confidence_weight"),
        "oi_positioning_state": first(sig, "oi_positioning_state", "opt__oi_positioning_state"),
        "volume_activity_state": first(sig, "volume_activity_state", "opt__volume_activity_state"),
        "option_activity_state": first(sig, "option_activity_state", "opt__option_activity_state"),
        "activity_evidence_strength": first(sig, "activity_evidence_strength", "opt__activity_evidence_strength"),
        "activity_directional_inference": first(sig, "activity_directional_inference", "opt__activity_directional_inference"),
        "activity_authority": first(sig, "activity_authority", "opt__activity_authority"),
        "activity_reason": first(sig, "activity_reason", "opt__activity_reason"),
...
def _lab_extract_field_aliases() -> Dict[str, List[str]]:
    return {
        ...
        "oi_positioning_state": ["oi_positioning_state", "opt__oi_positioning_state"],
        "volume_activity_state": ["volume_activity_state", "opt__volume_activity_state"],
        "option_activity_state": ["option_activity_state", "opt__option_activity_state"],
        "activity_evidence_strength": ["activity_evidence_strength", "opt__activity_evidence_strength"],
        "activity_directional_inference": ["activity_directional_inference", "opt__activity_directional_inference"],
        "activity_authority": ["activity_authority", "opt__activity_authority"],
        "activity_reason": ["activity_reason", "opt__activity_reason"],
